...
class ClipboardSyncActivity : AppCompatActivity() {
    ...
    companion object {
        private const val TAG = "ClipboardSyncActivity"
            ...
            try {
                ...
                runOnUiThread {
                    if (success) {
                        ...
                        Toast.makeText(this@ClipboardSyncActivity, message, Toast.LENGTH_LONG).show()
                        ...
                        Toast.makeText(this@ClipboardSyncActivity, "❌ 同步失败，请检查服务器", Toast.LENGTH_LONG).show()
                        prefs.edit().apply {
                ...
                runOnUiThread {
                    Toast.makeText(this@ClipboardSyncActivity, "❌ 发送异常: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
        }.start()
    }
    ...
    private fun testConnection() {
        ...
        Thread {
            ...
            runOnUiThread {
                if (success) {
                    Toast.makeText(this@ClipboardSyncActivity, "✅ 连接成功！", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this@ClipboardSyncActivity, "❌ 连接失败，请检查IP和端口", Toast.LENGTH_LONG).show()
                }
            }
        }.start()
    }
